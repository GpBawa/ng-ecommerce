...
@Component({
  ...
  imports: [TitleCasePipe, StockStatus, QtySelector, MatButton, MatIcon, ToggleWishlistButton, StarRating],
  template: `
    ...
    <p class="text-gray-600 border-6 border-gray-200 pb-4">{{product().description}}</p>
    ...
    <div class="flex gap-4 mb border-b border-gray-200 pb-4">
      <button matButton="filled" class="w-2/3 flex item-center gap-2" 
              (click)="store.addToCart(product(), quantity())" [disabled]="!product().inStock">
